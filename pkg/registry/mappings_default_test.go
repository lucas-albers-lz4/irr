...
// createTestMappingsContent creates the test content for a valid structured mappings file
...
registries:
  mappings:
    - source: docker.io
      ...
      enabled: true # Explicitly true (though default)
    - source: quay.io
    ...
    - source: gcr.io
      ...
      enabled: true
# defaultTarget: registry.example.com/default # Optional
# strictMode: false # Optional
# compatibility:
#   ignoreEmptyFields: false # Optional
`
}
